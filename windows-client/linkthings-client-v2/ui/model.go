...
import (
	...
	"linkthings.io/client-v2/api"
	"linkthings.io/client-v2/config"
	"linkthings.io/client-v2/keymgmt"
	"linkthings.io/client-v2/logging"
	"linkthings.io/client-v2/tunnel"
)
...
// cmdCopyToClipboard copies text to the system clipboard via the current platform's Clipboard.
func cmdCopyToClipboard(text string) tea.Cmd {
	return func() tea.Msg {
		if err := currentClipboard().Copy(text); err != nil {
