...
func currentElevator() Elevator { return windowsElevator{} }

func (windowsElevator) IsAdmin() bool {
...
func (windowsElevator) RelaunchElevated() bool {
...
func (windowsElevator) ShowElevationRequiredMessage() {
